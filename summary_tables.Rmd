...
for (city in cities) {
  ...
  y <- ggplot(prop) +
    ...
    labs(title = "", y = "Percentage (%)", x = paste("Trip Mode for", city)) + theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
  ...
  # save image
  #ggsave(paste0("figures/", city, "_scen_defn_mode.svg"), plot = y, width=10, height=8)
