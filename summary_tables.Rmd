...
#( - one table giving the city specific baseline average duration (h) spent travelling by each person in the respective synthetic populations for all cities  - CURRENTLY COMMENTED OUT)
