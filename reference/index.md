...
- [`add_ghost_trips()`](https://ithim.github.io/ITHIM-R/reference/add_ghost_trips.md)
  : Addition of ghost trips
- [`add_motorcycle_trips_Chile()`](https://ithim.github.io/ITHIM-R/reference/add_motorcycle_trips_Chile.md)
  : Personal motorcycle trips for Chilean cities
- [`add_trips()`](https://ithim.github.io/ITHIM-R/reference/add_trips.md)
...
- [`ap_dose_response_curve()`](https://ithim.github.io/ITHIM-R/reference/ap_dose_response_curve.md)
  : Computes RR as a DR relationship - CURRENTLY NOT USED
- [`assign_age_groups()`](https://ithim.github.io/ITHIM-R/reference/assign_age_groups.md)
  : Assign age groups to individuals
- [`beta_pointiness()`](https://ithim.github.io/ITHIM-R/reference/beta_pointiness.md)
...
- [`combine_health_and_pif()`](https://ithim.github.io/ITHIM-R/reference/combine_health_and_pif.md)
...
- [`create_bogota_scenarios()`](https://ithim.github.io/ITHIM-R/reference/create_bogota_scenarios.md)
  : Create scenarios for Bogota
- [`create_global_scenarios()`](https://ithim.github.io/ITHIM-R/reference/create_global_scenarios.md)
  : Create global scenarios
- [`create_base_pop()`](https://ithim.github.io/ITHIM-R/reference/create_base_pop.md)
...
- [`extract_data_for_voi()`](https://ithim.github.io/ITHIM-R/reference/extract_data_for_voi.md)
...
- [`ithim_setup_baseline_scenario()`](https://ithim.github.io/ITHIM-R/reference/ithim_setup_baseline_scenario.md)
...
- [`scale_trip_distances()`](https://ithim.github.io/ITHIM-R/reference/scale_trip_distances.md)
...
- [`set_injury_contingency()`](https://ithim.github.io/ITHIM-R/reference/set_injury_contingency.md)
  : Injury summary statistics
- [`set_scenario_specific_variables()`](https://ithim.github.io/ITHIM-R/reference/set_scenario_specific_variables.md)
...
- [`walk_to_pt_and_combine_scen()`](https://ithim.github.io/ITHIM-R/reference/walk_to_pt_and_combine_scen.md)
