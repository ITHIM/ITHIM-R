...
#USE demography package to interpolate moratlity rates. 
...
##This works, check what is the issue with the loop. Seems that the problem was with colon and rectum cancer mispelling. 

p_test <- plot_GBD(in_data1 = GBDEngland, in_data2 = GBDGL, in_sex = "male", in_cause = "colon and rectum cancer", in_measure = "deaths")
```
