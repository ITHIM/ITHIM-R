...
p_aggr_list_index <- ggplot(total_aggr[1:79,], aes(x = sim_year)) +
  
  geom_line(mapping = aes(y = paste("total", outcome, "num_bl", disease, sep = "_"), colour = paste("total", outcome, "num_bl", disease, sep = "_"))) +
  theme_classic() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_line(mapping = aes(y = paste("total", outcome, "num_sc", disease, sep = "_"), colour = paste("total", outcome, "num_sc", disease, sep = "_"))) +
  geom_line(mapping = aes(y = paste("total", outcome, "num_dif", disease, sep = "_"), colour = paste("total", outcome, "num_diff", disease, sep = "_"))) +
  xlab ("Simulation years") + ylab ("Cases") + labs (title = paste(disease)) +
