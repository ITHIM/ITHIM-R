...
mx_plot_compare_male <- ggplot() + 
geom_line(data=ggplot_data_England, aes(x= age_cat, y= one_rate), color='green') +
geom_line(data=ggplot_data_GL, aes(x= age_cat, y= one_rate), color='red') +
xlab ("Age") + ylab ("Rate per one") + labs (title = "Mortality rates comparison") +
theme_classic() +
scale_alpha_manual("Location", values = c("England", "Greater London")) +
