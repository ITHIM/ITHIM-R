...
Initial case studies for the ITHIMR are: London, Sao PAblo, Delhi, Accra, Los Angeles and Edinburgh. Here, we will start with **greater London** given the availability of dieases epidemiology data from the GBD IHME study. For the rest of the case study cities data is available at the country level, hence, a scaling method is needed. 
...
![Global Burden of Disease data results tool.](data/Figure4.png){width=70%,hight=50%,fig.pos="H"}
