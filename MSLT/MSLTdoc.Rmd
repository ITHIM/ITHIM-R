...
```{r, echo=FALSE}
pmslt_inputs <- matrix(c(1:15), ncol = 3, byrow = TRUE)
colnames(pmslt_inputs) <- c("Input", "Source", "Comments")
rownames (pmslt_inputs) <- c("Population numbers", "Death rates", "Years lived with disability rates", "Disease epidemilogy", "Disability weights")
print(pmslt_inputs)
```
