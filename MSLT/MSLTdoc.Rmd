...
## Give one rate a name to match merge in data_dismodii input

    }
  }
}

## Generate empy variables in data_dismodii for death, incidence and prevalence rates per disease
