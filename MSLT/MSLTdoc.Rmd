...
p_sex <- c("male", "female")
p_cause <- c("all causes", "ischemic heart disease", "ischemic stroke", "diabetes mellitus", "colon and rectum cancers", "breast cancer", "tracheal, bronchus, and lung cancer")
p_measure <- c("all causes", "ylds (years lived with disability)", "prevalence", "incidence")
