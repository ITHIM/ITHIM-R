...
23) Plot outcomes for each age and sex cohort using created functions. Two functions are used: plot_output (plots outputs) and grid_arrange_shared_legend (places one label per page).
      ...
      for (sex in i_sex) {
       ...
       if (sex == "male" && disease == "breast_cancer"){
         # cat("\n")
            ...
            # There are 4 diseases for males, this should be modified according to the modelled 
            # diseases. 
            ...
            if (sex == "male"){
              ...
              if (male_index %% 4 == 0 && male_index > 0){
                ...
                grid_arrange_shared_legend (p1, p2, p3, p4, ncol = 2, nrow = 2, mainTitle = paste(age, sex, outcome),mainLeft = 'Cases', mainBottom = 'Age')
                dev.off()
            ...
            # There are 5 diseases for females, this should be modified according to the modelled 
            # diseases. 
            ...
            if (sex == "female" && female_index > 0){
              ...
              if (female_index %% 5 == 0){
                ...
                pdf(paste0(output_dir, "/", paste(age, sex, outcome, sep="_"), ".pdf"))
                grid_arrange_shared_legend (p1, p2, p3, p4, p5, ncol = 2, nrow = 3, mainTitle = paste(age, sex, outcome), mainLeft = 'Cases', mainBottom = 'Age')
                dev.off()
