...
ALSO PART OF THE BELOW CODE WILL BE NEEDED FOR THE MSLT AND DISMOD COLLECTION. GENERATE DATA INPUTS FOR DISMOD II FROM HERE. 
...
##Create age categories index in GBDdata (rounding mid age)
...
##Convert variable val to numberic

GBDdata$val <- as.numeric(as.character(GBDdata$val))

##Filter data for England and Greater London adn generate per person rates (per 100,000 in original data)
#England
