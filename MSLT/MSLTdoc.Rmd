...
total_plot <- ggplot(total_aggr[1:79,], aes(x = sim_year)) +
  ...
  geom_line(mapping = aes(y = total_inc_num_bl_ihd, colour = "total_inc_num_bl_ihd")) +
  theme_classic() +
  geom_hline(yintercept=0, linetype="dashed", color = "black") +
  geom_line(mapping = aes(y = total_inc_num_sc_ihd, colour = "total_inc_num_sc_ihd")) +
  geom_line(mapping = aes(y = total_inc_num_diff_ihd, colour = "total_inc_num_diff_ihd")) +
