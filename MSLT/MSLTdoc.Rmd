...
mx_plot_compare <- ggplot(data = filter(GBDEngland, sex == "male", cause == "all causes" & measure == "deaths") %>% select(measure, location, sex, age, metric, cause, one_rate, age_cat), aes(x = age_cat)) +
    geom_line(mapping = aes(y = one_rate, colour = "one_rate")) +
  theme_classic() 
  

#Print to view
print(mx_plot_compare)
