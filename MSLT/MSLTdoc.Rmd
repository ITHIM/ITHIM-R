...
![Basic ITHIMR infrastructure](structure\Figure1.png){width=70%, fig.pos="H"}
...
The code below is to load the data used will be updated to the study cases. 

WRITE CODE HERE TO GET DATA. 
