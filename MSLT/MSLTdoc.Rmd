...
Table 1 describes data needs for the PMSLT, the data used here is for an example for Australia, however, this will be updated to link with the ITHIM-R modules and additional work required to generate data inputs. Here, we expand on Table 1 with the aim of providing clear guidance for the PMSLT data needs. 
