...
data_dismodii  <- merge(data_dismodii, select(paste(sex_index, measure_index, disease_index, sep = "_"),c(sex_age_cat, paste(measure_index, disease_index, sep = "_")), by = 'sex_age_cat', all.x = TRUE))
