...
##These are derived from total number of cases and rates per 100,000. To derive values we need to select one cause (E.g. all cause)-does not matter what we choose. 

###First generate population numbers for England and Greater London and then separate in dataframes
...
###Generate population numbers from GBD data
