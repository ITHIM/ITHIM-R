...
##I used spline function as the rates are not always monotonic. 


Mortality_males <- filter(GBDGL, measure == "deaths", sex == "male", cause == "all causes") %>% select(measure, location, sex, age, metric, cause, val, age_cat, one_rate)
