...
baseline$METh <- (METWalking * baseline$trip_walktime_min / 60) + (METWalking * baseline$walkrec10_wkhr / 60) +
  (METCycling * baseline$trip_cycletime_min / 60) + (METWalking * baseline$cyclerec_wkhr / 60) + baseline$sport_wkmets
baseline$MMETh <- ((METWalking - 1) * baseline$trip_walktime_min / 60) + ((METWalking - 1) * baseline$walkrec10_wkhr / 60) +
((METCycling - 1) * baseline$trip_cycletime_min / 60) + ((METCycling - 1) * baseline$cyclerec_wkhr / 60) + baseline$sport_wkmets
