...
injury_risks_lng_hours[injury_risks_lng_hours$scenario == 'bl',]$scenario <- 'Baseline'
...
injury_risks_lng_hours[injury_risks_lng_hours$scenario == 'csc',]$scenario <- 'Driving'
