...
# WARNING: Script assumes that the Baseline scenario corresponds to the known injury fatality counts in the city, i.e it assumes that the reference scenario is the Baseline scenario
...
```{r}
# Export injury datasets in a single excel file
