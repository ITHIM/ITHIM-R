...
readr::write_csv(inj_counts_list, paste0('results/multi_city/inj/inj_counts_',output_version,'.csv')) # table containing all the fatality counts
...
readr::write_csv(rd,paste0( 'results/multi_city/inj/injury_risks_per_billion_kms_',output_version,'.csv'))
...
# write to csv with and without output version number
readr::write_csv(injury_risks_per_100k %>% filter(mode != 'Total' & scenario != 'Total'), paste0('results/multi_city/inj/injury_risks_per_100k_pop_',output_version,'.csv'))

readr::write_csv(injury_risks_per_100k %>% filter(mode != 'Total' & scenario != 'Total'), paste0('results/multi_city/inj/injury_risks_per_100k_pop.csv'))
```
...
# write to csv with and without output version number
readr::write_csv(true_distances_df, paste0('results/multi_city/inj/distances_',output_version,'.csv'))
...
readr::write_csv(rd_hours, paste0('results/multi_city/inj/injury_risks_per_100million_h_',output_version,'.csv'))
...
path_inj_wb <- paste0('results/multi_city/inj/inj_data_',output_version,'.xlsx')
