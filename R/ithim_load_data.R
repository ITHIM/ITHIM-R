...
ithim_load_data <- function(setup_call_summary_filename,speeds=list(
  ...
  ## AA - Hard-coded
  ## INJURIES - Make all incidents of car, bus, motorcycle and bike with themselves, as NOV
  ## 25-02-2020
  
  # Get all injuries with same casualty and strike mode for car, bus, motorcycle and bike
