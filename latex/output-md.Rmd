...
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| \$\\epsilon \$                            | Walk time to bus                                                | 5 or Lnorm(log (5),0.18)           | BUS\_ WALK_TIME                | Setting        |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\mu_{m=HGV}$ \|                          | Truck distance relative to car \|                               | 0.21 or Beta(3,10)                 | TRUCK_TO\_ CAR_RATIO \| S      | etting         |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\mu_{m=bus}$ \|                          | Bus driver distance relative to bus passenger distance \|       | 1/45 or Bet a(20,600) \|           | BUS\_ TO_PASSEN GER_RATIO      | Setting        |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
...
| *Injury model values*                     |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $I _ {a,g,m_{\                            | Fatalities table                                                | Constant                           | INJURY_TABLE                   | Setting        |
| text{vi c} },m_{\text{str}}}$             |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
...
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\                                        | Vehicle emission inventory                                      | Constant or Dirichlet              | EMISSION_INVENTORY             | Setting        |
| g amma_{m}$                               |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $P$                                       | Vehicle emission confidence                                     | 1                                  | EM ISSION_INVENTORY_CONFIDENCE | Setting        |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| -   Pollution & health model              |                                                                 |                                    |                                |                |
|                                           |                                                                 |                                    |                                |                |
|     values\*                              |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $C_1$                                     | Base-level inhalation rate                                      | 1                                  | BAS E_LEVEL_I NHALATION \_RATE | Model          |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $C_2$                                     | Exposure ratio window closed                                    | 0.5                                | CLOSED_WI NDOW_PM\_ RATIO      | Model          |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
...
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\                                        | Quantiles for AP RR functions                                   | 0.5 or Unif(0,1)                   | AP_DOSE_R ESPONSE\_ QUANTILE   | Model          |
| xi_{h,w}$                                 |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| *Physical activity model values*          |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\chi$                                    | Day-to-week travel scalar                                       | 7 or 7 $\times$Beta(20,3)          | DAY_TO_WEEK \_TRAVEL_SCALAR    | Model          |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
...
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
| $\                                        | Confidence in PA survey                                         | 1                                  | BACKGROUND_PA_C ONFIDENCE      | Setting        |
| tilde{Y}$                                 |                                                                 |                                    |                                |                |
+-------------------------------------------+-----------------------------------------------------------------+------------------------------------+--------------------------------+----------------+
...
```{r out.height = "800px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("cancer_PA_dose_response.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', fg.cap = 'Distributions of univariate uncertain parameters (1024 samples).', echo=F}
knitr::include_graphics("uncertain_parameters.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("prob_zero_PA.pdf")
```

(){#prob_zero_PA width="50%"}
...
knitr::include_graphics("emission_dist.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F, fig.show='hold', fig.cap="We use the same uniform samples to generate random variables from different distributions. It means that the samples are perfectly correlated."}
knitr::include_graphics("DR_transform.pdf")
```
...
```{r out.height = "600px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("accra_walk_yll.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', fig.cap="EVPPI for Accra",fig.path="accra_walk_evppi.pdf", echo=F}
#knitr::include_graphics("accra_walk_evppi.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("ithim_with_parameters.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("PA_dose_response.pdf")
```
...
| *Travel calculations*                                                                                                                                        |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\{T_{j^+}\leftarrow \epsilon; m(j^+)\leftarrow\text{walk} \}\, \forall\, T_j:m(j)=\text{bus}$                                                               | New walk trips to bus                                                                          | walk *to_bus_and* combine_scen               |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\bar{T}_{a,g,m,s}=\sum_{j:a(j )= a,g(j)=g,m(j)=m,s(j)=s}Q_{i(j)}T_j$                                                                                        | (Weighted) total travel per age, gender, mode and scenario                                     |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| \$ \che ck{T}\_{a,g,m,s}=\frac{\bar{T}_{a,                                                                                                                   | Relative travel per mode and scenario by age and gender                                        | inj_distan ces\[\[1\]\]                      |
| g, m,s}}{\sum_{a,g}\bar{T}_{a,g,m,s}}\$                                                                                                                      |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\hat{ T} _{m,s}=\sum_{a,g}\bar{T}_{a,g,m,s}$                                                                                                                | Total travel per mode and scenario                                                             | dist                                         |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{T}_{m,s}=\frac{\hat{T}_{ m, s}}{\hat{T}_{m,s=\text{baseline}}}$                                                                                      | Total travel per mode and scenario relative to baseline, with car modes summed, and Tuktuk = 1 | inj_distan ces\[\[2\]\]                      |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| *Injury calculations*                                                                                                                                        |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $E_{m_{\text{cas}}}=\psi\omega$                                                                                                                              | Casualty exponent                                                                              | CAS_EXPONENT                                 |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $E_{m_{\t ex t{str}}}=\omega-E_{m_{\text{cas}}}$                                                                                                             | Striker exponent                                                                               | STR_EXPONENT                                 |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{I}_{a,g,m_{\text{vic}},m_{\text{str}},s}=\mathcal{S}\left(\sigma\c dot {I}_{a,g,m_{\text{vic}},m_{\text{| Fataliti                                   | es in scenarios by strike mode \| injuries                                                     |                                              |
| str}}},\bar{T}_{a,g,m,s},E_{m_{\t ex t{cas}}},E_{m_{\text{str}}}\right)$                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\check{I}_{a,g,m,o=\text{death                                                                                                                              | Fatalities in scenarios                                                                        | v ictim_deaths                               |
| },s} =\sum_{m_{\text{str}}}\tilde{I}_{ a, g,m_{\text{vic}},m_{\text{str}},s}$                                                                                |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $R_{a,g}=U_{a,g,h=\text{road                                                                                                                                 | Road YLL-to-death ratio                                                                        | GBD_INJ_YLL                                  |
| injuries},o=\text{YLL}}/U_{a,g,h= \t ext{road injuries},o=\text{death}}$                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\check{ I}_{ a,g,m,o=\text{YLL},s}=\check{I}_{ a, g,m,o=\text{death},s}\cdot R_{a,g}$                                                                       | YLLs scaled from fatalities                                                                    | deaths\_ yll_injuries                        |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| *Pollution calculations*                                                                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\dot{P}_{m}=\left\{\begin{array}{lr} \gam ma_m & P=1 \\ \tilde{\gamma}_m, \  | tilde{\gamma}_m \sim \text{Dir}(f(P,\  | gamma_m)) & P<1 \end{array}\right.$ | Emissions by mode \| \|                                                                        | tra ns_emissions                             |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{P}_{m,s}=\dot{P}_m\hat{T} _{ m,s}/\hat{T}_{m,s=\text{baseline}}$                                                                                     | Emissions by mode in scenario relative to baseline                                             | tra ns_emissions                             |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| \$ \h at{P}*{s}=*\sum{m} \tilde{P}\_{m,s}\$                                                                                                                  | Emissions scalar for scenarios                                                                 | baseline_sum                                 |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\bar {P}_s=\eta(\zeta\hat{P}_s + 1-\zeta)$ \|                                                                                                               | Background PM2.5 concentration in scenarios \|                                                 | scenario_pm                                  |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $K_s=C_4-C_5\log(\bar{P_s})$                                                                                                                                 | On-road PM2.5 exposure ratio                                                                   | on_road_of f_road_ratio                      |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{K}_{m\                                                                                                                                               | On-road PM2.5 exposure ratio for open vehicle                                                  | on_road_of f_road_ratio                      |
| in\{\text{walk,cyc.,mot.}\},s}=K_s$                                                                                                                          |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\                                                                                                                                                           | Subway PM2.5 exposure ratio \|                                                                 | subway_ratio                                 |
| tilde{K}_{m\in\{\text{sub.}\},s}=C_6$ \|                                                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\                                                                                                                                                           | In-vehicle PM2.5 exposure ratio                                                                | in_v ehicle_ratio                            |
| tilde{K}_{m\not\in\{\text{walk,cyc.                                                                                                                          |                                                                                                |                                              |
| ,mot.,sub.}\},s}=C_2C_3+K_s(1-C_3)$                                                                                                                          |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
...
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\bar{V}_{i,s} = \sum_{m}\t il de{V}_{i,m,s}\cdot \tilde{K}_{m,s}$                                                                                           | In-travel PM2.5 inhalation rate                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| \$ \hat{V}*{i,s} = C_1*\left(24-\sum{j                                                                                                                       | Non-travel air inhaled                                                                         |                                              |
| :i(j)=i,s(j)=s}T_j/Z\_{m(j)}\right)\$                                                                                                                        |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| \$\check{W}*{i,s} =* \bar{ P}*s(*\bar{V}{i,s}+\hat{V}{i,s})/24                                                                                               | Total PM2.5 inhaled per hour                                                                   |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| %/(\sum\*m\                                                                                                                                                  |                                                                                                |                                              |
| \*\tilde{V}{i,m,s}+\hat{V}\_{i,s})\$                                                                                                                         |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{H}_{a,h,w=3}=\text{CDF}_{H_{a ,h ,w=3}}^{-1}(\xi_{h,w=3})^{\dagger}$ \|                                                                              | AP dose-- response--curve parameter \|                                                         | DR_AP_LIST                                   |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{H}_{a,h,w=3} =\te xt{CDF}_{H_{a,h,w=3}|\tilde{H}_{a ,h ,w=3}}^{-1}(\xi_{h,w=3})^{\dagger}$                                                           | AP dose-- response--curve parameter                                                            | DR_AP_LIST                                   |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
...
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{H}_{a,h,w=3}=\text{CD                                                                                                                                | AP dose-- response--curve parameter                                                            | DR_AP_LIST                                   |
| F}_{H_{a,h,w=3}|\tilde{H}_{a,h, w=3} ,\tilde{H}_{a,h,w=3},\tilde{H}_{a ,h ,w=3}}^{-1}(\xi_{h,w=3})^{\dagger}$                                                |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\check{H}_{h,i,s} = 1 + \tilde{H}_{a=a(i),h,w=3}\times$                                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\left\{1 - \exp\left(-\tilde{H }_ {a=a(i),h,w=3} (\check{W}_{i,s} - \                                                                                       | RR of disease given pollution                                                                  | RR_AP\_ calculations                         |
| tilde{H}_{a=a(i),h,w=3}) ^ {\tild e{ H}_{a=a(i),h,w=3} }\right)\right\}$                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| *Physical activity calculations*                                                                                                                             |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\dot{Y}_{a,g}=\                                                                                                                                             | Raw probability non-travel MMETs = 0 for demographic group $a,g$                               | raw_zero                                     |
| text{Prob}(Y_i=0)|_{a(i)=a,g(i)=g}$                                                                                                                          |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\b ar{Y}_{a,g}=\left\{\begin{array }{lr } \dot{Y}_{a,g} & \tilde{Y}=1 \\ \t ext{CDF}_{\text{Beta}(f(\tilde{Y},\                                             | Probability non-travel MMETs = 0 for demographic group $a,g$                                   | zeros                                        |
| dot{Y}_{a,g}))}^{-1}(\tilde{\thet a} ) & \tilde{Y}<1 \end{array}\right.$                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\check{Y}_i = \left\{\begin {a rray}{lr} 0 & \bar{Y}_{a(i),g(i)} \                                                                                          | Non-travel MMETs                                                                               | SYNTHETIC\_ POPULATION\$ work_l tpa_marg_met |
| \ \text{Sample}(\{Y_{i'}\}|_{a( i')= a(i),g(i')=g(i),Y_{i'}>0}) & 1-\b ar {Y}_{a(i),g(i)} \end{array}\right.$                                                |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $M_{i,s}=\sum_{j :i(j )=i,s(j)=s}(\chi T_j\cdot \lambda _{ m(j)}/Z_{m(j)})+\theta \check{Y}_i$                                                               | Total MMETs per person                                                                         | mmets                                        |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{G}_{h,x}(m) = {G}_{h, x,z= \lfloor{m}\rfloor}+({G}_{h,x,z=\l ce il{m}\rceil}-{G}_{h,x,z=\lfloor{m}\                                                  | Interpolated dose--response parameters                                                         | rr, lb, ub                                   |
| rfloor})\frac{m-\lfloor{m}\rfloor }{ \lceil{m}\rceil-\lfloor{m}\rfloor}$                                                                                     |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $F_S(s_x) = \mathcal{N}(s_{x=2},( s_ {x=3}-s_{x=1})/1.96)|_{0<F_S(s_x)}$                                                                                     | Truncated normal function                                                                      |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $W_{h,i,s}=\text{CDF}_{F_S\                                                                                                                                  | Relative risk of disease given PA                                                              | RR_PA\_ calculations                         |
| left (\tilde{G}_{h,x}(M_{i,s})\right)} ^{ -1}\left(\phi_{h}\right)^{\dagger}$                                                                                |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| *Burden-of-disease calculations*                                                                                                                             |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{W}_{h, i, s}=W_{h,i,s}\cdot\check{H}_{h,i,s}$                                                                                                        | Combined PA and AP relative risks                                                              | RR_PA_AP\_ calculations                      |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\hat{W}_{a,g,h,s}= \su m_ {i:a(i)=a,g(i)=g}\tilde{W}_{h,i,s}$                                                                                               | Populati on-attributable fractions                                                             | pif_temp                                     |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\bar{W}_{a,g,h,s}= (\hat{W} _{a, g,h,s=\text{scen1}}-\hat{W}_{a,g, h, s})/\hat{W}_{a,g,h,s=\text{scen1}}$                                                   | Populati on-attributable fractions relative to scenario 1                                      | pif_scen                                     |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\bar{U}_{a,g,h,o}=U_{a ,g ,h,o}\frac{\bar{N}_{a,g}}{N_{a,g}}$                                                                                               | GBD scaled to local population                                                                 | DI SEASE_BURDEN                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\tilde{U}_{a, g, h,o}=\rho_h\cdot \bar{U}_{a,g,h,o}$                                                                                                        | Scaled background disease for Neoplasms, IHD, Lung cancer                                      | gbd \_data_scaled                            |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\hat{U}_{a,g,h,o,s}=\bar{ W} _{a,g,h,s}\cdot\tilde{U}_{a,g,h,o}$                                                                                            | Combined health and PIF                                                                        | yll_dfs, death_dfs                           |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
| $\hat{U}_{a,g,h=\text{road injury                                                                                                                            | Injury health burden                                                                           | inj                                          |
| },o,s}=\sum_m\check{I}_{a,g,m,o,s}$                                                                                                                          |                                                                                                |                                              |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------+----------------------------------------------+
...
We resample the adjusted probability parameters of Table [6](#calculations){reference-type="ref" reference="calculations"}. We describe each parameter with a Beta distribution as follows: $$\begin{aligned}
\label{pitilde}
\tilde{B}_{a,g,m} & \sim \text{Beta}(\alpha_{a,g,m},\beta_{a,g,m}); \\
\alpha_{a,g,m}+\beta_{a,g,m} & = 200; \\
\hat{B}_{a,g,m} & = \frac{1}{1+\frac{\beta_{a,g,m}}{\alpha_{a,g,m}}}.\end{aligned}$$ Here, $\tilde{B}_{a,g,m}$ is the new, variable parameter that we resample for each simulation. We sample via a quantile, $\nu_m\sim\mathcal{U}(0,1)$, which we use to calculate $\tilde{B}_{a,g,m}$. We set $\alpha_{a,g,m}$ and $\beta_{a,g,m}$ to sum to 200, making the distributions concentrated, and we constrain their relative values to enforce the distribution's mean to equal $\hat{B}_{a,g,m}$ (the right-most column in Table [6](#calculations){reference-type="ref" reference="calculations"}).
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("propensity_to_travel_200.pdf")
```

(){#propensity_to_travel width="70%"}
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("raw_densities.pdf")
```

(){#raw_densities width="80%"}

## Simulating a synthetic population {#synthpop}

1.  Choose a population size of individuals ${N}$. Label each individual $i=1,...,N$.

2.  Allocate each individual to a demographic group according to the proportions in the Accra population (Table [5](#population){reference-type="ref" reference="population"}). Then each demographic group has number $\tilde{N}_{a,g}$ and $\sum_{a,g}\tilde{N}_{a,g}=N$.
...
4.  $\tilde{B}_{a,g,m,s}$ is the propensity of group {$a,g$} to travel by mode $m$ in scenario $s$. It is the proportion of raw person--duration values that are zero. It is parametrised by $\alpha_{a,g,m,s}$ and $\beta_{a,g,m,s}$ (Equation [\[pitilde\]](#pitilde){reference-type="ref" reference="pitilde"}).
...
7.  Define each individual's travel duration as $D_{i,m,s}=7\cdot\text{CDF}_{\tilde{\mathcal{F}}_{a(i),g(i),m,s}}^{-1}(\delta_{i,m})$ (see Figure [18](#distances_beta){reference-type="ref" reference="distances_beta"} for resulting distributions).
...
6.  Let $\tilde{\mathcal{F}}_{a,g,m,s}^7$ be the week convolution of $\tilde{\mathcal{F}}_{a,g,m,s}$ (see Figure [17](#raw_densities){reference-type="ref" reference="raw_densities"}, right).

7.  Define each individual's travel duration as $D_{i,m,s}=7\pi\cdot\text{CDF}_{\tilde{\mathcal{F}}_{a(i),g(i),m,s}}^{-1}(\delta_{i,m})+(1-\pi)\cdot\text{CDF}_{\tilde{\mathcal{F}}_{a(i),g(i),m,s}^7}^{-1}(\delta_{i,m})$ (see Figure [18](#distances_beta){reference-type="ref" reference="distances_beta"} for resulting distributions).
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("distances_beta.pdf")
```

(){#distances_beta width="80%"}
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("accra_walk_yll_uncertain_travel.pdf")
```
...
```{r out.height = "460px", out.width='800px', fig.align='center', echo=F}
knitr::include_graphics("accra_walk_evppi_uncertain_travel.pdf")
```

(){#evppi_mode_propensities_200 width="70%"}
...
[^6]: Using the same random variable for both travel sets increases the variability of the resulting dataset. Conversely, using different random variables would result in more homogenous durations, and fewer zeros.
