...
io <- io[-2]
for(i in 1:length(io)) io[[i]]$outcomes$hb$deaths$age_cat[io[[i]]$outcomes$hb$deaths$age_cat=='5-9'] <- '05-9'
...
for(i in 1:length(io)) io[[i]]$demographic$age[io[[i]]$demographic$age=='5-9'] <- '05-9'
...
for(i in 1:length(io)) io[[i]]$outcomes$hb$ylls$age_cat[io[[i]]$outcomes$hb$ylls$age_cat=='5-9'] <- '05-9'
