...
df1 <- df %>% filter(!stage_mode %in% c('auto_rickshaw', 'bus', 'truck'))
df1 <- spread(data = df1, key = stage_mode, value = value)

readr::write_csv(df1, 'results/multi_city/whw_matrices/injury_risks_per_billion_kms_by_scen.csv')
