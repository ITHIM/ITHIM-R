...
sum_and_round_and_print(death_rates,"Change in deaths per 100,000 in ")
```
...
sum_and_round_and_print(yll_rates,"Change in YLLs per 100,000 in ")
```
...
sum_and_round_and_print(injury_rates,"Change in deaths due to injury per 100,000 in ")

pa_rates <- lapply(cities,function(x) pa_totals[[x]]/t(repmat(pop_by_age[[x]],5,1))*100000)
names(pa_rates) <- cities
sum_and_round_and_print(pa_rates,"Change in deaths due to PA per 100,000 in ")

ap_rates <- lapply(cities,function(x) ap_totals[[x]]/t(repmat(pop_by_age[[x]],5,1))*100000)
names(ap_rates) <- cities
sum_and_round_and_print(ap_rates,"Change in deaths due to AP per 100,000 in ")
```
...
injury_rates <- lapply(cities,function(x) injury_totals[[x]]/t(repmat(pop_by_age[[x]],5,1))*100000)
names(injury_rates) <- cities
sum_and_round_and_print(injury_rates,"Change in YLLs due to injury per 100,000 in ")

pa_rates <- lapply(cities,function(x) pa_totals[[x]]/t(repmat(pop_by_age[[x]],5,1))*100000)
names(pa_rates) <- cities
sum_and_round_and_print(pa_rates,"Change in YLLs due to PA per 100,000 in ")

ap_rates <- lapply(cities,function(x) ap_totals[[x]]/t(repmat(pop_by_age[[x]],5,1))*100000)
names(ap_rates) <- cities
sum_and_round_and_print(ap_rates,"Change in YLLs due to AP per 100,000 in ")
```
...
sum_and_round_and_print(disease_rates,"Change in deaths due to disease per 100,000 in ")
```
...
disease_rates <- lapply(cities,function(x) disease_totals[[x]]/sum(pop_by_age[[x]])*100000)
names(disease_rates) <- cities
sum_and_round_and_print(disease_rates,"Change in YLL due to disease per 100,000 in ")
```
