...
for (x in 1:length(cities)) {
  ...
  #                                                       "Motorcycling", 
  #                                                       "Public Transport")
  names(io[[cities[x]]]$outcomes$pm_conc_pp)[6:9] <- c("Baseline", "Bicycling",
...
co2_conc$Scenario <- c("Baseline", "Bicycling", "Driving", "Public Transport")
...
for (x in 1:length(cities)) {
  ...
  names(io[[cities[x]]]$outcomes$mmets)[5:8] <- c("Baseline", "Bicycling", 
                                                  "Driving", "Public Transport")
...
for (x in 1:length(cities)) {
  ...
  names(io[[cities[x]]]$outcomes$mmets)[5:8] <- c("baseline","bike_scen", 
                                                  "car_scen", "bus_scen")
...
for (city in cities)
{
  ...
  #  as.data.frame() %>% tibble::rownames_to_column()
  td <- round(colMeans(io[[city]]$outcomes$mmets[,5:8], na.rm = T), 1) %>%
    as.data.frame() %>% tibble::rownames_to_column()
  names(td) <- c('Scenario', city)
...
#cl$Scenario <- c("Baseline","Walking", "Bicycling", "Driving", "Motorcycling", "Public Transport")
cl$Scenario <- c("Baseline", "Bicycling", "Driving", "Public Transport")
...
for (x in 1:length(cities)) {
  ...
  #                                                       "Motorcycling", 
  #                                                       "Public Transport")
  names(io[[cities[x]]]$outcomes$pm_conc_pp)[6:9] <- c("Baseline",
                                                        "Bicycling", "Driving",
                                                        "Public Transport")
  ...
  td <- round(colSums(io[[cities[x]]]$outcomes$co2_conc, na.rm = T), 1) %>%
    as.data.frame() %>% tibble::rownames_to_column()
  #names(td) <- c('Scenario', cities[x])
  names(td) <- c('Scenario', 'CO2')
  # td$Scenario <- c("Baseline","Walking", "Bicycling", "Driving", "Motorcycling",
  #                  "Public Transport")
  td$Scenario <- c("Baseline", "Bicycling", "Driving", "Public Transport")
...
for (x in 1:length(cities)) {
  ...
  #                                                  "Motorcycling", 
  #                                                  "Public Transport")
  names(io[[cities[x]]]$outcomes$mmets)[5:8] <- c("Baseline",
                                                   "Bicycling", "Driving",
                                                   "Public Transport")
  data_long <- gather(io[[cities[x]]]$outcomes$mmets, scenario, mmet, Baseline:`Public Transport`, factor_key = TRUE)
