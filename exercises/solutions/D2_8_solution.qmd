...
# Print it
cat("Percentage unchanged people in cycle scenario ", 
percentage_unchanged_people_in_sc_cycle)

# Do the same for rest of the two scenarios
cat("Percentage unchanged people in bus scenario ", round((total_people_with_travel - (mmets_pp_total_wide |> filter(baseline == sc_bus) |> nrow())) / total_people_with_travel * 100, 2))

cat("Percentage unchanged people in car scenario ", round((total_people_with_travel - (mmets_pp_total_wide |> filter(baseline == sc_car) |> nrow())) / total_people_with_travel * 100, 2))
