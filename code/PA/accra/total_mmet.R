...
ind <- rd %>% group_by(participant_id) %>% summarise ( sex = first(sex), 
                                                       ...
                                                       base_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_base + walking_mmet_base,
                                                       scen1_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_scen1 + walking_mmet_scen1,
                                                       scen2_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_scen2 + walking_mmet_scen2,
                                                       scen3_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_scen3 + walking_mmet_scen3,
                                                       scen4_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_scen4 + walking_mmet_scen4,
                                                       scen5_mmet = first(work_ltpa_marg_met / PA_MULT[INDEX]) +  cycling_mmet_scen5 + walking_mmet_scen5
