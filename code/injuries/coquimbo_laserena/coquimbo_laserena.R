#' ---
#' title: "Preprocessing of Coquimbo and La Serena's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
#' According to the travel survey (page 2-1 of **Actualiz_diag_STU_Coquimbo_La Serena_Inf_Final.pdf**) 
#' the survey cover only comunas Coquimbo and La Serena
# unique(injuries$Región)
# sort(unique(injuries$Comuna))
# injuries <- injuries %>% filter(Comuna %in% c("LA SERENA", "COQUIMBO"))
# write_csv(injuries, paste0(path, "injuries_coquimbo.csv"))

injuries <- read_csv(paste0(path, "injuries_coquimbo.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Coquimbo_LaSerena/Cleaned/injuries_coquimbo_wb.csv')
write_csv(whw, 
          'inst/extdata/local/coquimbo_laserena/injuries_coquimbo_laserena.csv')
