#' ---
#' title: "Preprocessing of Puerto Montt's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
# injuries <- injuries %>% filter(Comuna == "PUERTO MONTT")
# write_csv(injuries, paste0(path, "injuries_puerto_montt.csv"))

injuries <- read_csv(paste0(path, "injuries_puerto_montt.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/PuertoMontt/Cleaned/injuries_puerto_montt_wb.csv')
write_csv(whw, 'inst/extdata/local/puerto_montt/injuries_puerto_montt.csv')
