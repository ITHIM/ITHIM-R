#' ---
#' title: "Preprocessing of Arica's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
#' According to the travel survey (page 2-1 of **Actualizacion_diag_STU_Arica_Inf_Final.pdf**) 
#' the survey cover only comuna Arica
# unique(injuries$Región)
# sort(unique(injuries$Comuna))
# injuries <- injuries %>% filter(Comuna == "ARICA")
# write_csv(injuries, paste0(path, "injuries_arica.csv"))

injuries <- read_csv(paste0(path, "injuries_arica.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Arica/Cleaned/injuries_arica_wb.csv')
write_csv(whw, 'inst/extdata/local/arica/injuries_arica.csv')
