#' ---
#' title: "Preprocessing of Copiapo's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
# injuries <- injuries %>% filter(Comuna == "COPIAPO")
# write_csv(injuries, paste0(path, "injuries_copiapo.csv"))

injuries <- read_csv(paste0(path, "injuries_copiapo.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Copiapo/Cleaned/injuries_copiapo_wb.csv')
write_csv(whw, 'inst/extdata/local/copiapo/injuries_copiapo.csv')
