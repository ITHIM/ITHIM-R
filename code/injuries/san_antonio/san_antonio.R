#' ---
#' title: "Preprocessing of San Antonio's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
# injuries <- injuries %>% filter(Comuna == "SAN ANTONIO")
# write_csv(injuries, paste0(path, "injuries_san_antonio.csv"))

injuries <- read_csv(paste0(path, "injuries_san_antonio.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/SanAntonio/Cleaned/injuries_san_antonio_wb.csv')
write_csv(whw, 'inst/extdata/local/san_antonio/injuries_san_antonio.csv')
