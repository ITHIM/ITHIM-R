#' ---
#' title: "Preprocessing of Valdivia's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
# injuries <- injuries %>% filter(Comuna == "VALDIVIA")
# write_csv(injuries, paste0(path, "injuries_valdivia.csv"))

injuries <- read_csv(paste0(path, "injuries_valdivia.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Valdivia/Cleaned/injuries_valdivia_wb.csv')
write_csv(whw, 'inst/extdata/local/valdivia/injuries_valdivia.csv')
