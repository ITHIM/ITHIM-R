#' ---
#' title: "Preprocessing of Antofagasta's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
#' According to the travel survey (page 3-1 of **Actualiz_diag_STU_Antofagasta_Inf_Final.pdf**) 
#' the survey cover only comunas Antofagasta
#' 
# unique(injuries$Región)
# sort(unique(injuries$Comuna))
# injuries_antofagasta <- injuries %>% 
#   filter(Comuna == "ANTOFAGASTA")
# write_csv(injuries_antofagasta, paste0(path, "injuries_antofagasta.csv"))

injuries <- read_csv(paste0(path, "injuries_antofagasta.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Antofagasta/Cleaned/injuries_antofagasta_wb.csv')
write_csv(whw, 'inst/extdata/local/antofagasta/injuries_antofagasta.csv')
