#' ---
#' title: "Preprocessing of Iquique and Alto Hospicio's injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
#' According to the travel survey (in the whole document of **Actualiz_diag_STU_Copiapo_Inf_ Final.pdf**) 
#' the survey cover only comuna Copiapo
# unique(injuries$Región)
# sort(unique(injuries$Comuna))
# injuries <- injuries %>% filter(Comuna %in% c("IQUIQUE", "ALTO HOSPICIO"))
# write_csv(injuries, paste0(path, "injuries_iquique.csv"))

injuries <- read_csv(paste0(path, "injuries_iquique.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Iquique_AltoHospicio/Cleaned/injuries_iquique_wb.csv')
write_csv(whw, 'inst/extdata/local/iquique_altohospicio/injuries_iquique_altohospicio.csv')
