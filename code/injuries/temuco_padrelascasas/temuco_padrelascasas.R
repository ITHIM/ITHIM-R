#' ---
#' title: "Preprocessing of Temuco and Padre Las Casas' injuries dataset"
#' author: "Daniel"
#' output:
#'   html_document:
#'     toc: true
...
# injuries <- injuries %>% filter(Comuna %in% c("TEMUCO", "PADRE LAS CASAS"))
# write_csv(injuries, paste0(path, "injuries_temuco.csv"))

injuries <- read_csv(paste0(path, "injuries_temuco.csv"))
...
# Export file
#write_csv(whw, 'C:/Users/danie/Documents/Daniel_Gil/Consultorias/2020/WorldBank/Data/Chile/Temuco_PadreDeLasCasas/Cleaned/injuries_temuco_wb.csv')
write_csv(whw, 'inst/extdata/local/temuco_padrelascasas/injuries_temuco_padrelascasas.csv')
